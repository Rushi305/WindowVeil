 ...
 */
// Assuming you're defining an object with methods
<script type="module">

const myObject = {
	ce: function() {
	  // ce function implementation
	},
	se: function() {
	  // se function implementation
	},
	refresh: function() {
	  // refresh function implementation
	},
	refreshHard: function() {
	//   refreshHard function implementation
	}
  };
...
!(function (r) {
  "use strict";
  r.fn.LineProgressbar = function (t) {
    return (
      (t = r.extend(
        {
          percentage: 100,
      ...
      this.each(function (a, o) {
        ...
        var n = r(o).find(".proggress"),
          i = r(o).find(".progressbar");
        n.css({
          backgroundColor: t.fillBackgroundColor,
          height: t.height,
                ...
                { width: t.percentage + "%" },
                {
                  step: function (a) {
                    t.ShowProgressCount &&
                      r(o)
                        .find(".percentCount")
                        .text(Math.round(a) + t.unit);
                  },
                  duration: t.duration,
                }
              )
            : (n.css("width", t.percentage + "%"),
              r(o)
                .find(".percentCount")
                .text(Math.round(t.percentage) + "%"));
      })
    );
  };
})(jQuery),
      ...
      function () {
        (t += 1) < 2 &&
          r.LineProgressbar({
            ...
            ShowProgressCount: r.data("showcount"),
            duration: r.data("duration"),
            fillBackgroundColor: r.data("progress-color"),
            backgroundColor: r.data("bg-color"),
